...
export const GITHUB_REPO_URL = "https://github.com/avaritiachaos/Avaritia-Roo-Code"
...
// GitHub links
export const GITHUB_MAIN_REPO_URL = "https://github.com/avaritiachaos/Avaritia-Roo-Code"
export const GITHUB_ISSUES_MAIN_URL = `${GITHUB_MAIN_REPO_URL}/issues`

// Download links
export const VSCODE_MARKETPLACE_URL =
	"https://marketplace.visualstudio.com/items?itemName=avaritiachaos.avaritia-roo-code"
export const OPEN_VSX_URL = "https://open-vsx.org/extension/avaritiachaos/avaritia-roo-code"
